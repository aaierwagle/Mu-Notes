...
export function EditDialog({ assignmentId }: EditDialogProps) {
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="grid gap-2">
            ...
            {/* Use a textarea for description instead of Input */}
            <textarea
              id="description"
        ...
        <DialogFooter className="sm:justify-start">
          ...
          <Button type="submit" variant="destructive" onClick={handleEdit}>
            Save
          </Button>
        </DialogFooter>
      </DialogContent>
